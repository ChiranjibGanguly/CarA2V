...
public class MultiPartRequest extends Request<String> {
    ...
    private AddVehicleInfoActivity addVehicleActivity;


    public MultiPartRequest(Response.ErrorListener errorListener, Response.Listener listener, ArrayList<File> file, int numberOfFiles, Map<String, String> params, AddVehicleInfoActivity addVehicleInfoActivity) {
        super(Method.POST, Constant.BASE_URL+Constant.addVehicleUrl, errorListener);
        mListener = listener;
        mParams=params;
        mHttpEntity = buildMultipartEntity(file, numberOfFiles);
        addVehicleActivity=addVehicleInfoActivity;
    }
    ...
    public Map<String, String> getHeaders() throws AuthFailureError {
        ...
        header.put("authToken", PreferenceConnector.readString(addVehicleActivity, PreferenceConnector.AuthToken, ""));
        return header;
    }
