...
public class ImageUtil {
    ...
    public static void saveImageFromBitmap(Bitmap bitmap , Context context){
        ContextWrapper cw = new ContextWrapper(context);
    ...
    public static void storeImage(Bitmap image , Context context) {
        ...
        if (pictureFile == null) {
            /**///Log.d("Store_Image","Error creating media file, check storage permissions: ");// e.getMessage());
            return;
        }
        try {
            ...
            /**///Log.d("Store_Image", "Error accessing file: " + e.getMessage());
        }
    }
