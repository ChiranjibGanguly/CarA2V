...
public class SendQuotedServiceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private ArrayList<QuotedServicesBean> serviceList;
    AddPriceListioner addPriceListioner;
    int mRowHeight;

    public SendQuotedServiceAdapter(Context context, ArrayList<QuotedServicesBean> serviceList, AddPriceListioner addPriceListioner) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        final SendQuotedServiceAdapter.MyViewHolder h = (SendQuotedServiceAdapter.MyViewHolder) holder;
        QuotedServicesBean dataBean = serviceList.get(h.getAdapterPosition());
        if (!TextUtils.isEmpty(dataBean.getServiceImage()))
            Log.e("ServiceImage", dataBean.getServiceImage() );
        ...
        h.subList.setAdapter(new SendQuotedSubServiceBaseAdapter(context, dataBean.getQuotedSubServiceBeans(), new RemoveImageListioner() {
            @Override
   ...
   /* public static void getTotalHeightofListView(final ListView listView) {
