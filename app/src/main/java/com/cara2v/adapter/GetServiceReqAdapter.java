...
public class GetServiceReqAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private ArrayList<AddServicesResponce.DataBean> serviceList;
    private RemoveImageListioner infoClickListioner;

    public GetServiceReqAdapter(Context context, ArrayList<AddServicesResponce.DataBean> serviceList, RemoveImageListioner infoClickListioner) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_ser_rq_list_group, parent, false);
        return new MyViewHolder(view);
    }
    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {

        GetServiceReqAdapter.MyViewHolder h = (GetServiceReqAdapter.MyViewHolder) holder;
        AddServicesResponce.DataBean dataBean = serviceList.get(h.getAdapterPosition());
        ...
        /*h.subList.setAdapter(new ArrayAdapter<AddServicesResponce.DataBean>(context, R.layout.item_service_check, R.id.subItemText, (ArrayList) dataBean.getSubService()));*/
        h.subList.setAdapter(new ItemServiceCheckBaseAdapter(context, dataBean.getSubService()));
            ...
            arrowBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (dataBean.isVisible()) {
                        ...
                        //  arrowBtn.setBackgroundResource(R.drawable.down_arrow_service);
                        // containerLay.setVisibility(View.VISIBLE);
                        serviceList.get(getAdapterPosition()).setVisible(false);
                    } else if (!dataBean.isVisible()) {
                        //  subView.setVisibility(View.VISIBLE);
                        //  arrowBtn.setBackgroundResource(R.drawable.up_arrow_service);
