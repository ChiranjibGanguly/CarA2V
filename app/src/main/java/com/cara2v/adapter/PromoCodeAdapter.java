...
public class PromoCodeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PromoCodeAdapter(Context context, List<GetAllPromoCodeResponce.DataBean> allPromoCodeList, AddEditPromocodeListioner addEditPromocodeListioner) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        final PromoCodeAdapter.MyViewHolder h = (PromoCodeAdapter.MyViewHolder) holder;
